...
import com.zzh.yummy.config.FatUtils
import com.zzh.yummy.config.VersionAdapter
import kotlin.Pair
...
class FlavorArtifactNew {
    ...
    public static ResolvedArtifact createFlavorArtifact(Project project, LibraryVariant variant, ResolvedDependency unResolvedArtifact) {
        FatUtils.logAnytime("project android=" + project.android)
